            ...
            {open && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-[15%] z-[1000] w-full max-w-[560px] -translate-x-1/2 overflow-hidden rounded-2xl border border-[var(--vct-border-strong)] bg-[var(--vct-bg-card)] shadow-2xl"
                    >
                        {/* Search bar */}
                        <div className="flex items-center gap-3 border-b border-[var(--vct-border-subtle)] px-4 py-3">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent text-sm font-medium text-[var(--vct-text-primary)] outline-none placeholder:text-[var(--vct-text-muted)]"
                            />
                            <kbd className="shrink-0 rounded-md border border-[var(--vct-border-subtle)] bg-[var(--vct-bg-elevated)] px-2 py-0.5 text-[10px] font-bold text-[var(--vct-text-tertiary)]">
                                ESC
                            </kbd>
                        </div>
                                        ...
                                        {items.map(item => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`flex w-full items-center gap-3 border-none px-4 py-2.5 text-left font-inherit text-sm font-semibold transition-colors ${isActive ? 'bg-[var(--vct-accent-cyan)]/10 text-[var(--vct-accent-cyan)]' : 'bg-transparent text-[var(--vct-text-primary)] hover:bg-[var(--vct-bg-elevated)]'}`}
                                                >
                                                    ...
                                                    {item.shortcut && (
                                                        <kbd className="rounded border border-[var(--vct-border-subtle)] bg-[var(--vct-bg-elevated)] px-1.5 py-0.5 text-[10px] font-bold opacity-50">
                                                            {item.shortcut}
                                                        </kbd>
                                                    )}
                                                </button>
                        ...
                        {/* Footer hint */}
                        <div className="flex items-center gap-4 border-t border-[var(--vct-border-subtle)] px-4 py-2 text-[10px] font-bold opacity-40">
                            <span>↑↓ Di chuyển</span>
                            <span>⏎ Chọn</span>
                            <span>ESC Đóng</span>
